 ...
 * 效益平台回傳結果型別
 */
export declare type BnftResponse = PlatformResponse<ProducePayloadModel<Bnft.BenefitSaving>>;
/**
 * 使用率平台回傳結果型別
 */
export declare type SumkResponse = PlatformResponse<UsagePayload>;
/**
 * 異常事件報警中心回傳結果型別
 */
